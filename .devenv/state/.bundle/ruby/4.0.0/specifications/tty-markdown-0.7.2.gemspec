# -*- encoding: utf-8 -*-
# stub: tty-markdown 0.7.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<kramdown>.freeze, [">= 1.16.2".freeze, "< 3.0".freeze])
  s.add_runtime_dependency(%q<pastel>.freeze, ["~> 0.8".freeze])
  s.add_runtime_dependency(%q<rouge>.freeze, [">= 3.14".freeze, "< 5.0".freeze])
